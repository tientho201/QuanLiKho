...
public class NVXuatHang extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					final NVXuatHang frame = new NVXuatHang();
...
//		panel_1.setBounds(327,10,1180,750);
		...
		PanelXuatHang.setBounds(10, 125, 297, 37);
		...
		lblXuatHang.setIcon(new ImageIcon(NVXuatHang.class.getResource("/com/quanlikho/Item/XuatHang_24.png")));
		...
		PanelPhieuXuat.setBounds(10, 184, 297, 37);
		...
		lblPhieuXuat.setIcon(new ImageIcon(NVXuatHang.class.getResource("/com/quanlikho/Item/bill_24.png")));
		...
		PanelTonKho.setBounds(10, 243, 297, 37);
		...
		lblTongKho.setIcon(new ImageIcon(NVXuatHang.class.getResource("/com/quanlikho/Item/tongkho_24.png")));
		...
		lbldangxuat.setIcon(new ImageIcon(NVXuatHang.class.getResource("/com/quanlikho/Item/logout_24.png")));
		...
		lblDoiThongTin.setIcon(new ImageIcon(NVXuatHang.class.getResource("/com/quanlikho/Item/doimatkhau_24.png")));
